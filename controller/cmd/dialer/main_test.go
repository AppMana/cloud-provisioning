...
// WGAllowedIPs. Conflating these two was the root cause of the the on-prem host
...
func TestLoadPeersFromSecret_AllowListAndRouteHostAreIndependent(t *testing.T) {
	secret := &corev1.Secret{
		...
		Data: map[string][]byte{
			...
			"dialer-private-key-the on-prem host": []byte("unrelated"), // must NOT be treated as a peer
		},
	}
