...
provider releases it after that UID disappears. The `cmd/vmprovider` loop and `cmd/lab -remote-slots` option provide command-level
configuration. Native pooled lifecycle tests remain pending.
