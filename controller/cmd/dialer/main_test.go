...
// route path -- the exact shape of the jarvis 0.0.0.0/0 incident -- is
...
// different values -- conflating them was the root cause of the jarvis
// incident.
func TestLoadPeersFromSecret_AllowListAndRouteHostsAreIndependent(t *testing.T) {
	secret := &corev1.Secret{
		...
		Data: map[string][]byte{
			...
			"node-public-key-jarvis":   []byte("unrelated"),  // must NOT be treated as a peer
		},
	}
