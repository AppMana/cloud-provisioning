...
profile results and their original version scope. Those runs need repetition
before qualifying updated versions.

| Additional scenario | Recorded result | Remaining gate |
| --- | --- | --- |
| k0s `1.36.2`, Calico pooled VM groups | [✅ scale-down, PDB hold, zero, reuse, and 2,880 survivor checks](docs/node-groups.md#tested-scenarios) | Pending-worker cancellation, Ready aggregation, and KEDA |
